 ...
 */
export default {
  name: env.APP_NAME ?? 'CommsHQ',
  description: 'Creator-first email, SMS, publishing, automation, and commerce marketing.',
  env: env.APP_ENV ?? 'local',
  url: env.APP_URL ?? 'commshq.localhost',
  redirectUrls: ['commshq.org', 'www.commshq.org'],
