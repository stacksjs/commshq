...
export default {
  ...
  nav: [
    ...
    },
    {
      ...
      items: [
        { label: 'Publications', href: '/models/publication', icon: 'i-hugeicons-news-01' },
        { label: 'Sites and forms', href: '/models/form-definition', icon: 'i-hugeicons-web-design-02' },
        { label: 'Commerce', href: '/commerce/dashboard', icon: 'i-hugeicons-shopping-bag-02' },
        { label: 'Monetization', href: '/models/earning', icon: 'i-hugeicons-money-receive-circle' },
        { label: 'Analytics', href: '/analytics/marketing', icon: 'i-hugeicons-chart-line-data-02' },
      ],
    },
    {
      title: 'Deliverability',
      items: [
        { label: 'Domains and senders', href: '/models/sender-domain', icon: 'i-hugeicons-mail-validation-01' },
        { label: 'Integrations', href: '/models/commerce-connection', icon: 'i-hugeicons-plug-socket' },
        { label: 'Billing and usage', href: '/settings/billing', icon: 'i-hugeicons-credit-card' },
        { label: 'Team and access', href: '/data/teams', icon: 'i-hugeicons-shield-user' },
      ],
    },
  ],
