...
export function createClient(config: ClientConfig) {
  ...
  /**
   * GET /api/v1/ad-inventory
   */
  getV1AdInventory(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "format": "newsletter" | "web" | "podcast" | "recommendation"; "position": string; "rate": number; "currency": string; "capacity": number; "status": "active" | "paused" | "sold_out" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/ad-inventory", {}, [], false, options)
  },

  /**
   * POST /api/v1/ad-inventory
   */
  postV1AdInventory(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "format": "newsletter" | "web" | "podcast" | "recommendation"; "position": string; "rate": number; "currency": string; "capacity": number; "status": "active" | "paused" | "sold_out" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/ad-inventory", {}, [], false, options)
  },

  /**
   * POST /api/v1/ad-inventory/bulk-delete
   */
  postV1AdInventoryBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/ad-inventory/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/ad-inventory/{id}
   */
  getV1AdInventoryId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "format": "newsletter" | "web" | "podcast" | "recommendation"; "position": string; "rate": number; "currency": string; "capacity": number; "status": "active" | "paused" | "sold_out" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/ad-inventory/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/ad-inventory/{id}
   */
  putV1AdInventoryId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "format": "newsletter" | "web" | "podcast" | "recommendation"; "position": string; "rate": number; "currency": string; "capacity": number; "status": "active" | "paused" | "sold_out" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/ad-inventory/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/ad-inventory/{id}
   */
  deleteV1AdInventoryId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "format": "newsletter" | "web" | "podcast" | "recommendation"; "position": string; "rate": number; "currency": string; "capacity": number; "status": "active" | "paused" | "sold_out" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/ad-inventory/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/ad-inventory/{id}
   */
  patchV1AdInventoryId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "format": "newsletter" | "web" | "podcast" | "recommendation"; "position": string; "rate": number; "currency": string; "capacity": number; "status": "active" | "paused" | "sold_out" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/ad-inventory/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/ad-placements
   */
  getV1AdPlacements(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "slot_key": string; "rate": number; "impressions": number; "clicks": number; "status": "reserved" | "approved" | "delivered" | "cancelled"; "team_id"?: number; "advertiser_offer_id"?: number; "campaign_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/ad-placements", {}, [], false, options)
  },

  /**
   * POST /api/v1/ad-placements
   */
  postV1AdPlacements(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "slot_key": string; "rate": number; "impressions": number; "clicks": number; "status": "reserved" | "approved" | "delivered" | "cancelled"; "team_id"?: number; "advertiser_offer_id"?: number; "campaign_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/ad-placements", {}, [], false, options)
  },

  /**
   * POST /api/v1/ad-placements/bulk-delete
   */
  postV1AdPlacementsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/ad-placements/bulk-delete", {}, [], false, options)
  },
   ...
   */
  getV1AdPlacementsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "slot_key": string; "rate": number; "impressions": number; "clicks": number; "status": "reserved" | "approved" | "delivered" | "cancelled"; "team_id"?: number; "advertiser_offer_id"?: number; "campaign_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/ad-placements/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/ad-placements/{id}
   */
  putV1AdPlacementsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "slot_key": string; "rate": number; "impressions": number; "clicks": number; "status": "reserved" | "approved" | "delivered" | "cancelled"; "team_id"?: number; "advertiser_offer_id"?: number; "campaign_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/ad-placements/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/ad-placements/{id}
   */
  deleteV1AdPlacementsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "slot_key": string; "rate": number; "impressions": number; "clicks": number; "status": "reserved" | "approved" | "delivered" | "cancelled"; "team_id"?: number; "advertiser_offer_id"?: number; "campaign_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/ad-placements/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/ad-placements/{id}
   */
  patchV1AdPlacementsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "slot_key": string; "rate": number; "impressions": number; "clicks": number; "status": "reserved" | "approved" | "delivered" | "cancelled"; "team_id"?: number; "advertiser_offer_id"?: number; "campaign_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/ad-placements/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/advertiser-offers
   */
  getV1AdvertiserOffers(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "creative": unknown; "budget": number; "currency": string; "starts_at"?: unknown; "ends_at"?: unknown; "status": "draft" | "offered" | "accepted" | "active" | "completed" | "cancelled"; "team_id"?: number; "sponsor_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/advertiser-offers", {}, [], false, options)
  },

  /**
   * POST /api/v1/advertiser-offers
   */
  postV1AdvertiserOffers(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "creative": unknown; "budget": number; "currency": string; "starts_at"?: unknown; "ends_at"?: unknown; "status": "draft" | "offered" | "accepted" | "active" | "completed" | "cancelled"; "team_id"?: number; "sponsor_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/advertiser-offers", {}, [], false, options)
  },

  /**
   * POST /api/v1/advertiser-offers/bulk-delete
   */
  postV1AdvertiserOffersBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/advertiser-offers/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/advertiser-offers/{id}
   */
  getV1AdvertiserOffersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "creative": unknown; "budget": number; "currency": string; "starts_at"?: unknown; "ends_at"?: unknown; "status": "draft" | "offered" | "accepted" | "active" | "completed" | "cancelled"; "team_id"?: number; "sponsor_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/advertiser-offers/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/advertiser-offers/{id}
   */
  putV1AdvertiserOffersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "creative": unknown; "budget": number; "currency": string; "starts_at"?: unknown; "ends_at"?: unknown; "status": "draft" | "offered" | "accepted" | "active" | "completed" | "cancelled"; "team_id"?: number; "sponsor_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/advertiser-offers/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/advertiser-offers/{id}
   */
  deleteV1AdvertiserOffersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "creative": unknown; "budget": number; "currency": string; "starts_at"?: unknown; "ends_at"?: unknown; "status": "draft" | "offered" | "accepted" | "active" | "completed" | "cancelled"; "team_id"?: number; "sponsor_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/advertiser-offers/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/advertiser-offers/{id}
   */
  patchV1AdvertiserOffersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "creative": unknown; "budget": number; "currency": string; "starts_at"?: unknown; "ends_at"?: unknown; "status": "draft" | "offered" | "accepted" | "active" | "completed" | "cancelled"; "team_id"?: number; "sponsor_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/advertiser-offers/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/ai-generations
   */
  getV1AiGenerations(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "purpose": "writing" | "segmentation" | "summary" | "optimization" | "recommendation"; "model": string; "prompt_hash": string; "provenance": unknown; "input_tokens": number; "output_tokens": number; "cost": number; "status": "draft" | "approved" | "rejected" | "published"; "approved_by"?: number; "approved_at"?: unknown; "team_id"?: number; "user_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/ai-generations", {}, [], false, options)
  },

  /**
   * GET /api/v1/ai-generations/{id}
   */
  getV1AiGenerationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "purpose": "writing" | "segmentation" | "summary" | "optimization" | "recommendation"; "model": string; "prompt_hash": string; "provenance": unknown; "input_tokens": number; "output_tokens": number; "cost": number; "status": "draft" | "approved" | "rejected" | "published"; "approved_by"?: number; "approved_at"?: unknown; "team_id"?: number; "user_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/ai-generations/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/attribution-events
   */
  getV1AttributionEvents(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "kind": "visit" | "signup" | "conversion" | "purchase" | "renewal" | "churn"; "source": string; "medium"?: string; "campaign_key"?: string; "revenue"?: number; "currency"?: string; "occurred_at": unknown; "team_id"?: number; "contact_id"?: number; "commerce_event_id"?: number; "campaign_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/attribution-events", {}, [], false, options)
  },

  /**
   * GET /api/v1/attribution-events/{id}
   */
  getV1AttributionEventsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "visit" | "signup" | "conversion" | "purchase" | "renewal" | "churn"; "source": string; "medium"?: string; "campaign_key"?: string; "revenue"?: number; "currency"?: string; "occurred_at": unknown; "team_id"?: number; "contact_id"?: number; "commerce_event_id"?: number; "campaign_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/attribution-events/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/audience-exports
   */
  getV1AudienceExports(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "status": "pending" | "processing" | "completed" | "expired" | "failed"; "filters": unknown; "row_count": number; "expires_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/audience-exports", {}, [], false, options)
  },

  /**
   * POST /api/v1/audience-exports
   */
  postV1AudienceExports(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "pending" | "processing" | "completed" | "expired" | "failed"; "filters": unknown; "row_count": number; "expires_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/audience-exports", {}, [], false, options)
  },

  /**
   * GET /api/v1/audience-exports/{id}
   */
  getV1AudienceExportsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "pending" | "processing" | "completed" | "expired" | "failed"; "filters": unknown; "row_count": number; "expires_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/audience-exports/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/audience-imports
   */
  getV1AudienceImports(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "filename": string; "status": "pending" | "validating" | "processing" | "completed" | "failed"; "mapping": unknown; "total_rows": number; "imported_rows": number; "rejected_rows": number; "completed_at"?: unknown; "team_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/audience-imports", {}, [], false, options)
  },

  /**
   * POST /api/v1/audience-imports
   */
  postV1AudienceImports(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "filename": string; "status": "pending" | "validating" | "processing" | "completed" | "failed"; "mapping": unknown; "total_rows": number; "imported_rows": number; "rejected_rows": number; "completed_at"?: unknown; "team_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/audience-imports", {}, [], false, options)
  },

  /**
   * GET /api/v1/audience-imports/{id}
   */
  getV1AudienceImportsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "filename": string; "status": "pending" | "validating" | "processing" | "completed" | "failed"; "mapping": unknown; "total_rows": number; "imported_rows": number; "rejected_rows": number; "completed_at"?: unknown; "team_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/audience-imports/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/audience-memberships
   */
  getV1AudienceMemberships(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "status": "active" | "pending" | "unsubscribed"; "joined_at": unknown; "left_at"?: unknown; "team_id"?: number; "audience_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/audience-memberships", {}, [], false, options)
  },

  /**
   * POST /api/v1/audience-memberships
   */
  postV1AudienceMemberships(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "active" | "pending" | "unsubscribed"; "joined_at": unknown; "left_at"?: unknown; "team_id"?: number; "audience_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/audience-memberships", {}, [], false, options)
  },

  /**
   * POST /api/v1/audience-memberships/bulk-delete
   */
  postV1AudienceMembershipsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/audience-memberships/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/audience-memberships/{id}
   */
  getV1AudienceMembershipsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "active" | "pending" | "unsubscribed"; "joined_at": unknown; "left_at"?: unknown; "team_id"?: number; "audience_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/audience-memberships/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/audience-memberships/{id}
   */
  deleteV1AudienceMembershipsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "active" | "pending" | "unsubscribed"; "joined_at": unknown; "left_at"?: unknown; "team_id"?: number; "audience_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/audience-memberships/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/audience-tags
   */
  getV1AudienceTags(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "color": string; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/audience-tags", {}, [], false, options)
  },

  /**
   * POST /api/v1/audience-tags
   */
  postV1AudienceTags(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "color": string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/audience-tags", {}, [], false, options)
  },

  /**
   * POST /api/v1/audience-tags/bulk-delete
   */
  postV1AudienceTagsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/audience-tags/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/audience-tags/{id}
   */
  getV1AudienceTagsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "color": string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/audience-tags/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/audience-tags/{id}
   */
  putV1AudienceTagsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "color": string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/audience-tags/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/audience-tags/{id}
   */
  deleteV1AudienceTagsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "color": string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/audience-tags/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/audience-tags/{id}
   */
  patchV1AudienceTagsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "color": string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/audience-tags/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/audiences
   */
  getV1Audiences(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "description"?: string; "channel": "all" | "email" | "sms"; "member_count": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/audiences", {}, [], false, options)
  },

  /**
   * POST /api/v1/audiences
   */
  postV1Audiences(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "channel": "all" | "email" | "sms"; "member_count": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/audiences", {}, [], false, options)
  },

  /**
   * POST /api/v1/audiences/bulk-delete
   */
  postV1AudiencesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/audiences/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/audiences/{id}
   */
  getV1AudiencesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "channel": "all" | "email" | "sms"; "member_count": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/audiences/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/audiences/{id}
   */
  putV1AudiencesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "channel": "all" | "email" | "sms"; "member_count": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/audiences/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/audiences/{id}
   */
  deleteV1AudiencesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "channel": "all" | "email" | "sms"; "member_count": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/audiences/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/audiences/{id}
   */
  patchV1AudiencesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "channel": "all" | "email" | "sms"; "member_count": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/audiences/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/audit-events
   */
  getV1AuditEvents(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "action": string; "subject_type"?: string; "subject_id"?: string; "metadata": unknown; "ip_address"?: string; "occurred_at": unknown; "team_id"?: number; "user_id"?: number }> }>> {
    return request(config, "GET", "/api/v1/audit-events", {}, [], false, options)
  },

  /**
   * GET /api/v1/audit-events/{id}
   */
  getV1AuditEventsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "action": string; "subject_type"?: string; "subject_id"?: string; "metadata": unknown; "ip_address"?: string; "occurred_at": unknown; "team_id"?: number; "user_id"?: number } }>> {
    return request(config, "GET", "/api/v1/audit-events/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/automation-approvals
   */
  getV1AutomationApprovals(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "action": string; "payload": unknown; "status": "pending" | "approved" | "rejected" | "expired" | "cancelled"; "requested_by": number; "decided_by"?: number; "reason"?: string; "expires_at"?: unknown; "decided_at"?: unknown; "team_id"?: number; "automation_id"?: number; "automation_run_id"?: number; "automation_step_run_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/automation-approvals", {}, [], false, options)
  },

  /**
   * GET /api/v1/automation-approvals/{id}
   */
  getV1AutomationApprovalsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "action": string; "payload": unknown; "status": "pending" | "approved" | "rejected" | "expired" | "cancelled"; "requested_by": number; "decided_by"?: number; "reason"?: string; "expires_at"?: unknown; "decided_at"?: unknown; "team_id"?: number; "automation_id"?: number; "automation_run_id"?: number; "automation_step_run_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/automation-approvals/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/automation-approvals/{id}
   */
  putV1AutomationApprovalsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "action": string; "payload": unknown; "status": "pending" | "approved" | "rejected" | "expired" | "cancelled"; "requested_by": number; "decided_by"?: number; "reason"?: string; "expires_at"?: unknown; "decided_at"?: unknown; "team_id"?: number; "automation_id"?: number; "automation_run_id"?: number; "automation_step_run_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/automation-approvals/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/automation-approvals/{id}
   */
  patchV1AutomationApprovalsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "action": string; "payload": unknown; "status": "pending" | "approved" | "rejected" | "expired" | "cancelled"; "requested_by": number; "decided_by"?: number; "reason"?: string; "expires_at"?: unknown; "decided_at"?: unknown; "team_id"?: number; "automation_id"?: number; "automation_run_id"?: number; "automation_step_run_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/automation-approvals/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/automation-dead-letters
   */
  getV1AutomationDeadLetters(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "node_id": string; "payload": unknown; "error_class": string; "error_message": string; "attempts": number; "status": "open" | "replaying" | "recovered" | "discarded"; "recovered_by"?: number; "recovered_at"?: unknown; "team_id"?: number; "automation_id"?: number; "automation_run_id"?: number; "automation_step_run_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/automation-dead-letters", {}, [], false, options)
  },

  /**
   * GET /api/v1/automation-dead-letters/{id}
   */
  getV1AutomationDeadLettersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "node_id": string; "payload": unknown; "error_class": string; "error_message": string; "attempts": number; "status": "open" | "replaying" | "recovered" | "discarded"; "recovered_by"?: number; "recovered_at"?: unknown; "team_id"?: number; "automation_id"?: number; "automation_run_id"?: number; "automation_step_run_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/automation-dead-letters/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/automation-dead-letters/{id}
   */
  putV1AutomationDeadLettersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "node_id": string; "payload": unknown; "error_class": string; "error_message": string; "attempts": number; "status": "open" | "replaying" | "recovered" | "discarded"; "recovered_by"?: number; "recovered_at"?: unknown; "team_id"?: number; "automation_id"?: number; "automation_run_id"?: number; "automation_step_run_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/automation-dead-letters/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/automation-dead-letters/{id}
   */
  patchV1AutomationDeadLettersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "node_id": string; "payload": unknown; "error_class": string; "error_message": string; "attempts": number; "status": "open" | "replaying" | "recovered" | "discarded"; "recovered_by"?: number; "recovered_at"?: unknown; "team_id"?: number; "automation_id"?: number; "automation_run_id"?: number; "automation_step_run_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/automation-dead-letters/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/automation-step-runs
   */
  getV1AutomationStepRuns(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "node_id": string; "type": string; "status": "queued" | "running" | "waiting" | "completed" | "failed" | "dead_lettered" | "cancelled"; "attempt": number; "idempotency_key": string; "input"?: unknown; "output"?: unknown; "error"?: string; "available_at"?: unknown; "started_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "automation_run_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/automation-step-runs", {}, [], false, options)
  },

  /**
   * GET /api/v1/automation-step-runs/{id}
   */
  getV1AutomationStepRunsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "node_id": string; "type": string; "status": "queued" | "running" | "waiting" | "completed" | "failed" | "dead_lettered" | "cancelled"; "attempt": number; "idempotency_key": string; "input"?: unknown; "output"?: unknown; "error"?: string; "available_at"?: unknown; "started_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "automation_run_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/automation-step-runs/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/automation-versions
   */
  getV1AutomationVersions(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "version": number; "graph": unknown; "checksum": string; "published_by": number; "published_at": unknown; "team_id"?: number; "automation_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/automation-versions", {}, [], false, options)
  },

  /**
   * GET /api/v1/automation-versions/{id}
   */
  getV1AutomationVersionsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "version": number; "graph": unknown; "checksum": string; "published_by": number; "published_at": unknown; "team_id"?: number; "automation_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/automation-versions/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/campaign-experiments
   */
  getV1CampaignExperiments(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "kind": "subject" | "sender" | "content" | "send_time"; "allocation": unknown; "winning_metric": "open_rate" | "click_rate" | "conversion_rate" | "revenue"; "status": "draft" | "running" | "evaluating" | "completed" | "cancelled"; "winner_variant_id"?: number; "evaluate_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "campaign_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/campaign-experiments", {}, [], false, options)
  },

  /**
   * POST /api/v1/campaign-experiments
   */
  postV1CampaignExperiments(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "subject" | "sender" | "content" | "send_time"; "allocation": unknown; "winning_metric": "open_rate" | "click_rate" | "conversion_rate" | "revenue"; "status": "draft" | "running" | "evaluating" | "completed" | "cancelled"; "winner_variant_id"?: number; "evaluate_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "campaign_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/campaign-experiments", {}, [], false, options)
  },

  /**
   * GET /api/v1/campaign-experiments/{id}
   */
  getV1CampaignExperimentsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "subject" | "sender" | "content" | "send_time"; "allocation": unknown; "winning_metric": "open_rate" | "click_rate" | "conversion_rate" | "revenue"; "status": "draft" | "running" | "evaluating" | "completed" | "cancelled"; "winner_variant_id"?: number; "evaluate_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "campaign_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/campaign-experiments/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/campaign-experiments/{id}
   */
  putV1CampaignExperimentsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "subject" | "sender" | "content" | "send_time"; "allocation": unknown; "winning_metric": "open_rate" | "click_rate" | "conversion_rate" | "revenue"; "status": "draft" | "running" | "evaluating" | "completed" | "cancelled"; "winner_variant_id"?: number; "evaluate_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "campaign_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/campaign-experiments/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/campaign-experiments/{id}
   */
  patchV1CampaignExperimentsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "subject" | "sender" | "content" | "send_time"; "allocation": unknown; "winning_metric": "open_rate" | "click_rate" | "conversion_rate" | "revenue"; "status": "draft" | "running" | "evaluating" | "completed" | "cancelled"; "winner_variant_id"?: number; "evaluate_at"?: unknown; "completed_at"?: unknown; "team_id"?: number; "campaign_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/campaign-experiments/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/campaign-recipients
   */
  getV1CampaignRecipients(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "channel": "email" | "sms"; "status": "queued" | "sent" | "delivered" | "failed" | "suppressed" | "cancelled"; "snapshot": unknown; "scheduled_at"?: unknown; "team_id"?: number; "campaign_id"?: number; "contact_id"?: number; "campaign_variant_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/campaign-recipients", {}, [], false, options)
  },

  /**
   * GET /api/v1/campaign-recipients/{id}
   */
  getV1CampaignRecipientsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms"; "status": "queued" | "sent" | "delivered" | "failed" | "suppressed" | "cancelled"; "snapshot": unknown; "scheduled_at"?: unknown; "team_id"?: number; "campaign_id"?: number; "contact_id"?: number; "campaign_variant_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/campaign-recipients/{id}", input ?? {}, [], false, options)
  },

  /**
   * POST /api/v1/campaigns/{id}/dispatch
   */
  postV1CampaignsIdDispatch(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/campaigns/{id}/dispatch", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/commerce-connections
   */
  getV1CommerceConnections(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "provider": "stacks" | "shopify" | "woocommerce" | "stripe" | "csv" | "api"; "name": string; "external_account_id"?: string; "status": "pending" | "active" | "error" | "disabled"; "last_synced_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/commerce-connections", {}, [], false, options)
  },

  /**
   * POST /api/v1/commerce-connections
   */
  postV1CommerceConnections(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider": "stacks" | "shopify" | "woocommerce" | "stripe" | "csv" | "api"; "name": string; "external_account_id"?: string; "status": "pending" | "active" | "error" | "disabled"; "last_synced_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/commerce-connections", {}, [], false, options)
  },

  /**
   * POST /api/v1/commerce-connections/bulk-delete
   */
  postV1CommerceConnectionsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/commerce-connections/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/commerce-connections/{id}
   */
  getV1CommerceConnectionsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider": "stacks" | "shopify" | "woocommerce" | "stripe" | "csv" | "api"; "name": string; "external_account_id"?: string; "status": "pending" | "active" | "error" | "disabled"; "last_synced_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/commerce-connections/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/commerce-connections/{id}
   */
  putV1CommerceConnectionsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider": "stacks" | "shopify" | "woocommerce" | "stripe" | "csv" | "api"; "name": string; "external_account_id"?: string; "status": "pending" | "active" | "error" | "disabled"; "last_synced_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/commerce-connections/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/commerce-connections/{id}
   */
  deleteV1CommerceConnectionsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider": "stacks" | "shopify" | "woocommerce" | "stripe" | "csv" | "api"; "name": string; "external_account_id"?: string; "status": "pending" | "active" | "error" | "disabled"; "last_synced_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/commerce-connections/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/commerce-connections/{id}
   */
  patchV1CommerceConnectionsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider": "stacks" | "shopify" | "woocommerce" | "stripe" | "csv" | "api"; "name": string; "external_account_id"?: string; "status": "pending" | "active" | "error" | "disabled"; "last_synced_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/commerce-connections/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/commerce-events
   */
  getV1CommerceEvents(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "external_id": string; "type": "product_viewed" | "cart_updated" | "checkout_started" | "order_created" | "order_paid" | "order_fulfilled" | "order_refunded" | "subscription_changed"; "amount"?: number; "currency"?: string; "payload": unknown; "occurred_at": unknown; "team_id"?: number; "commerce_connection_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/commerce-events", {}, [], false, options)
  },

  /**
   * GET /api/v1/commerce-events/{id}
   */
  getV1CommerceEventsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "external_id": string; "type": "product_viewed" | "cart_updated" | "checkout_started" | "order_created" | "order_paid" | "order_fulfilled" | "order_refunded" | "subscription_changed"; "amount"?: number; "currency"?: string; "payload": unknown; "occurred_at": unknown; "team_id"?: number; "commerce_connection_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/commerce-events/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/commissions
   */
  getV1Commissions(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "kind": "referral" | "recommendation" | "sponsorship" | "affiliate"; "gross_amount": number; "fee_basis_points": number; "fee_amount": number; "net_amount": number; "currency": string; "status": "pending" | "approved" | "payable" | "paid" | "reversed"; "payable_at"?: unknown; "paid_at"?: unknown; "team_id"?: number; "earning_id"?: number; "referral_id"?: number; "recommendation_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/commissions", {}, [], false, options)
  },

  /**
   * GET /api/v1/commissions/{id}
   */
  getV1CommissionsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "referral" | "recommendation" | "sponsorship" | "affiliate"; "gross_amount": number; "fee_basis_points": number; "fee_amount": number; "net_amount": number; "currency": string; "status": "pending" | "approved" | "payable" | "paid" | "reversed"; "payable_at"?: unknown; "paid_at"?: unknown; "team_id"?: number; "earning_id"?: number; "referral_id"?: number; "recommendation_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/commissions/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/contact-field-values
   */
  getV1ContactFieldValues(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "value"?: unknown; "team_id"?: number; "contact_id"?: number; "custom_field_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/contact-field-values", {}, [], false, options)
  },

  /**
   * POST /api/v1/contact-field-values
   */
  postV1ContactFieldValues(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "value"?: unknown; "team_id"?: number; "contact_id"?: number; "custom_field_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/contact-field-values", {}, [], false, options)
  },

  /**
   * POST /api/v1/contact-field-values/bulk-delete
   */
  postV1ContactFieldValuesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/contact-field-values/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/contact-field-values/{id}
   */
  getV1ContactFieldValuesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "value"?: unknown; "team_id"?: number; "contact_id"?: number; "custom_field_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/contact-field-values/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/contact-field-values/{id}
   */
  putV1ContactFieldValuesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "value"?: unknown; "team_id"?: number; "contact_id"?: number; "custom_field_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/contact-field-values/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/contact-field-values/{id}
   */
  deleteV1ContactFieldValuesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "value"?: unknown; "team_id"?: number; "contact_id"?: number; "custom_field_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/contact-field-values/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/contact-field-values/{id}
   */
  patchV1ContactFieldValuesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "value"?: unknown; "team_id"?: number; "contact_id"?: number; "custom_field_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/contact-field-values/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/contact-identities
   */
  getV1ContactIdentities(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "channel": "email" | "sms" | "push" | "external"; "value": string; "verified_at"?: unknown; "is_primary": boolean; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/contact-identities", {}, [], false, options)
  },

  /**
   * POST /api/v1/contact-identities
   */
  postV1ContactIdentities(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms" | "push" | "external"; "value": string; "verified_at"?: unknown; "is_primary": boolean; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/contact-identities", {}, [], false, options)
  },

  /**
   * POST /api/v1/contact-identities/bulk-delete
   */
  postV1ContactIdentitiesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/contact-identities/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/contact-identities/{id}
   */
  getV1ContactIdentitiesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms" | "push" | "external"; "value": string; "verified_at"?: unknown; "is_primary": boolean; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/contact-identities/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/contact-identities/{id}
   */
  putV1ContactIdentitiesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms" | "push" | "external"; "value": string; "verified_at"?: unknown; "is_primary": boolean; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/contact-identities/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/contact-identities/{id}
   */
  deleteV1ContactIdentitiesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms" | "push" | "external"; "value": string; "verified_at"?: unknown; "is_primary": boolean; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/contact-identities/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/contact-identities/{id}
   */
  patchV1ContactIdentitiesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms" | "push" | "external"; "value": string; "verified_at"?: unknown; "is_primary": boolean; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/contact-identities/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/contact-merges
   */
  getV1ContactMerges(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "source_contact_uuid": string; "snapshot": unknown; "merged_by_user_id": number; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/contact-merges", {}, [], false, options)
  },

  /**
   * GET /api/v1/contact-merges/{id}
   */
  getV1ContactMergesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "source_contact_uuid": string; "snapshot": unknown; "merged_by_user_id": number; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/contact-merges/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/contact-tags
   */
  getV1ContactTags(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "source": string; "applied_by"?: number; "team_id"?: number; "contact_id"?: number; "audience_tag_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/contact-tags", {}, [], false, options)
  },

  /**
   * POST /api/v1/contact-tags
   */
  postV1ContactTags(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "source": string; "applied_by"?: number; "team_id"?: number; "contact_id"?: number; "audience_tag_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/contact-tags", {}, [], false, options)
  },

  /**
   * POST /api/v1/contact-tags/bulk-delete
   */
  postV1ContactTagsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/contact-tags/bulk-delete", {}, [], false, options)
  },

  /**
   * DELETE /api/v1/contact-tags/{id}
   */
  deleteV1ContactTagsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "source": string; "applied_by"?: number; "team_id"?: number; "contact_id"?: number; "audience_tag_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/contact-tags/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/contacts
   */
  getV1Contacts(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "email"?: string; "phone"?: string; "first_name"?: string; "last_name"?: string; "status": "active" | "pending" | "unsubscribed" | "suppressed" | "archived"; "source": string; "properties"?: unknown; "last_engaged_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/contacts", {}, [], false, options)
  },

  /**
   * POST /api/v1/contacts
   */
  postV1Contacts(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "email"?: string; "phone"?: string; "first_name"?: string; "last_name"?: string; "status": "active" | "pending" | "unsubscribed" | "suppressed" | "archived"; "source": string; "properties"?: unknown; "last_engaged_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/contacts", {}, [], false, options)
  },

  /**
   * POST /api/v1/contacts/bulk-delete
   */
  postV1ContactsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/contacts/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/contacts/{id}
   */
  getV1ContactsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "email"?: string; "phone"?: string; "first_name"?: string; "last_name"?: string; "status": "active" | "pending" | "unsubscribed" | "suppressed" | "archived"; "source": string; "properties"?: unknown; "last_engaged_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/contacts/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/contacts/{id}
   */
  putV1ContactsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "email"?: string; "phone"?: string; "first_name"?: string; "last_name"?: string; "status": "active" | "pending" | "unsubscribed" | "suppressed" | "archived"; "source": string; "properties"?: unknown; "last_engaged_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/contacts/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/contacts/{id}
   */
  deleteV1ContactsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "email"?: string; "phone"?: string; "first_name"?: string; "last_name"?: string; "status": "active" | "pending" | "unsubscribed" | "suppressed" | "archived"; "source": string; "properties"?: unknown; "last_engaged_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/contacts/{id}", input ?? {}, [], false, options)
  },
   ...
   */
  patchV1ContactsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "email"?: string; "phone"?: string; "first_name"?: string; "last_name"?: string; "status": "active" | "pending" | "unsubscribed" | "suppressed" | "archived"; "source": string; "properties"?: unknown; "last_engaged_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/contacts/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/custom-fields
   */
  getV1CustomFields(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "key": string; "type": "text" | "number" | "boolean" | "date" | "select" | "json"; "options"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/custom-fields", {}, [], false, options)
  },

  /**
   * POST /api/v1/custom-fields
   */
  postV1CustomFields(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "key": string; "type": "text" | "number" | "boolean" | "date" | "select" | "json"; "options"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/custom-fields", {}, [], false, options)
  },

  /**
   * POST /api/v1/custom-fields/bulk-delete
   */
  postV1CustomFieldsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/custom-fields/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/custom-fields/{id}
   */
  getV1CustomFieldsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "key": string; "type": "text" | "number" | "boolean" | "date" | "select" | "json"; "options"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/custom-fields/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/custom-fields/{id}
   */
  putV1CustomFieldsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "key": string; "type": "text" | "number" | "boolean" | "date" | "select" | "json"; "options"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/custom-fields/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/custom-fields/{id}
   */
  deleteV1CustomFieldsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "key": string; "type": "text" | "number" | "boolean" | "date" | "select" | "json"; "options"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/custom-fields/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/custom-fields/{id}
   */
  patchV1CustomFieldsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "key": string; "type": "text" | "number" | "boolean" | "date" | "select" | "json"; "options"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/custom-fields/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/data-requests
   */
  getV1DataRequests(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "type": "access" | "export" | "erasure" | "restriction" | "correction"; "status": "pending" | "verifying" | "processing" | "completed" | "rejected"; "jurisdiction"?: string; "requested_at": unknown; "completed_at"?: unknown; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/data-requests", {}, [], false, options)
  },

  /**
   * POST /api/v1/data-requests
   */
  postV1DataRequests(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "access" | "export" | "erasure" | "restriction" | "correction"; "status": "pending" | "verifying" | "processing" | "completed" | "rejected"; "jurisdiction"?: string; "requested_at": unknown; "completed_at"?: unknown; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/data-requests", {}, [], false, options)
  },

  /**
   * GET /api/v1/data-requests/{id}
   */
  getV1DataRequestsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "access" | "export" | "erasure" | "restriction" | "correction"; "status": "pending" | "verifying" | "processing" | "completed" | "rejected"; "jurisdiction"?: string; "requested_at": unknown; "completed_at"?: unknown; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/data-requests/{id}", input ?? {}, [], false, options)
  },
   ...
   */
  putV1DataRequestsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "access" | "export" | "erasure" | "restriction" | "correction"; "status": "pending" | "verifying" | "processing" | "completed" | "rejected"; "jurisdiction"?: string; "requested_at": unknown; "completed_at"?: unknown; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/data-requests/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/data-requests/{id}
   */
  patchV1DataRequestsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "access" | "export" | "erasure" | "restriction" | "correction"; "status": "pending" | "verifying" | "processing" | "completed" | "rejected"; "jurisdiction"?: string; "requested_at": unknown; "completed_at"?: unknown; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/data-requests/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/data-retention-policies
   */
  getV1DataRetentionPolicies(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "kind": "contacts" | "events" | "deliveries" | "analytics" | "audit" | "integrations"; "retention_days": number; "legal_hold": boolean; "jurisdiction"?: string; "status": "active" | "paused"; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/data-retention-policies", {}, [], false, options)
  },

  /**
   * POST /api/v1/data-retention-policies
   */
  postV1DataRetentionPolicies(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "contacts" | "events" | "deliveries" | "analytics" | "audit" | "integrations"; "retention_days": number; "legal_hold": boolean; "jurisdiction"?: string; "status": "active" | "paused"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/data-retention-policies", {}, [], false, options)
  },

  /**
   * GET /api/v1/data-retention-policies/{id}
   */
  getV1DataRetentionPoliciesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "contacts" | "events" | "deliveries" | "analytics" | "audit" | "integrations"; "retention_days": number; "legal_hold": boolean; "jurisdiction"?: string; "status": "active" | "paused"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/data-retention-policies/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/data-retention-policies/{id}
   */
  putV1DataRetentionPoliciesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "contacts" | "events" | "deliveries" | "analytics" | "audit" | "integrations"; "retention_days": number; "legal_hold": boolean; "jurisdiction"?: string; "status": "active" | "paused"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/data-retention-policies/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/data-retention-policies/{id}
   */
  patchV1DataRetentionPoliciesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "kind": "contacts" | "events" | "deliveries" | "analytics" | "audit" | "integrations"; "retention_days": number; "legal_hold": boolean; "jurisdiction"?: string; "status": "active" | "paused"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/data-retention-policies/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/delivery-attempts
   */
  getV1DeliveryAttempts(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "channel": "email" | "sms"; "provider": string; "provider_message_id"?: string; "idempotency_key": string; "attempt": number; "status": "pending" | "sending" | "deferred" | "sent" | "failed" | "dead_lettered"; "retry_class"?: "transient" | "rate_limited" | "permanent" | "suppressed"; "error_code"?: string; "error_message"?: string; "retry_at"?: unknown; "attempted_at": unknown; "team_id"?: number; "campaign_recipient_id"?: number; "campaign_send_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/delivery-attempts", {}, [], false, options)
  },

  /**
   * GET /api/v1/delivery-attempts/{id}
   */
  getV1DeliveryAttemptsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms"; "provider": string; "provider_message_id"?: string; "idempotency_key": string; "attempt": number; "status": "pending" | "sending" | "deferred" | "sent" | "failed" | "dead_lettered"; "retry_class"?: "transient" | "rate_limited" | "permanent" | "suppressed"; "error_code"?: string; "error_message"?: string; "retry_at"?: unknown; "attempted_at": unknown; "team_id"?: number; "campaign_recipient_id"?: number; "campaign_send_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/delivery-attempts/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/delivery-events
   */
  getV1DeliveryEvents(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "channel": "email" | "sms" | "push"; "type": "queued" | "sent" | "delivered" | "opened" | "clicked" | "failed" | "bounced" | "complained" | "unsubscribed"; "provider": string; "provider_event_id": string; "delivery_key": string; "payload": unknown; "occurred_at": unknown; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/delivery-events", {}, [], false, options)
  },

  /**
   * GET /api/v1/delivery-events/{id}
   */
  getV1DeliveryEventsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms" | "push"; "type": "queued" | "sent" | "delivered" | "opened" | "clicked" | "failed" | "bounced" | "complained" | "unsubscribed"; "provider": string; "provider_event_id": string; "delivery_key": string; "payload": unknown; "occurred_at": unknown; "team_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/delivery-events/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/earnings
   */
  getV1Earnings(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "source_type": "paid_publication" | "sponsorship" | "recommendation" | "digital_product" | "referral"; "source_id": string; "gross_amount": number; "fee_amount": number; "net_amount": number; "currency": string; "occurred_at": unknown; "team_id"?: number; "ad_placement_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/earnings", {}, [], false, options)
  },

  /**
   * GET /api/v1/earnings/{id}
   */
  getV1EarningsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "source_type": "paid_publication" | "sponsorship" | "recommendation" | "digital_product" | "referral"; "source_id": string; "gross_amount": number; "fee_amount": number; "net_amount": number; "currency": string; "occurred_at": unknown; "team_id"?: number; "ad_placement_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/earnings/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/email-messages
   */
  getV1EmailMessages(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "subject": string; "preheader"?: string; "from_name": string; "from_address": string; "reply_to"?: string; "document": unknown; "html"?: string; "text"?: string; "revision": number; "team_id"?: number; "campaign_id"?: number; "message_template_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/email-messages", {}, [], false, options)
  },

  /**
   * POST /api/v1/email-messages
   */
  postV1EmailMessages(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "subject": string; "preheader"?: string; "from_name": string; "from_address": string; "reply_to"?: string; "document": unknown; "html"?: string; "text"?: string; "revision": number; "team_id"?: number; "campaign_id"?: number; "message_template_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/email-messages", {}, [], false, options)
  },

  /**
   * POST /api/v1/email-messages/bulk-delete
   */
  postV1EmailMessagesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/email-messages/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/email-messages/{id}
   */
  getV1EmailMessagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "subject": string; "preheader"?: string; "from_name": string; "from_address": string; "reply_to"?: string; "document": unknown; "html"?: string; "text"?: string; "revision": number; "team_id"?: number; "campaign_id"?: number; "message_template_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/email-messages/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/email-messages/{id}
   */
  putV1EmailMessagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "subject": string; "preheader"?: string; "from_name": string; "from_address": string; "reply_to"?: string; "document": unknown; "html"?: string; "text"?: string; "revision": number; "team_id"?: number; "campaign_id"?: number; "message_template_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/email-messages/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/email-messages/{id}
   */
  deleteV1EmailMessagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "subject": string; "preheader"?: string; "from_name": string; "from_address": string; "reply_to"?: string; "document": unknown; "html"?: string; "text"?: string; "revision": number; "team_id"?: number; "campaign_id"?: number; "message_template_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/email-messages/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/email-messages/{id}
   */
  patchV1EmailMessagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "subject": string; "preheader"?: string; "from_name": string; "from_address": string; "reply_to"?: string; "document": unknown; "html"?: string; "text"?: string; "revision": number; "team_id"?: number; "campaign_id"?: number; "message_template_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/email-messages/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/entitlements
   */
  getV1Entitlements(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "key": string; "value": unknown; "source": "plan" | "override" | "promotion"; "expires_at"?: unknown; "team_id"?: number; "subscription_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/entitlements", {}, [], false, options)
  },

  /**
   * GET /api/v1/entitlements/{id}
   */
  getV1EntitlementsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "key": string; "value": unknown; "source": "plan" | "override" | "promotion"; "expires_at"?: unknown; "team_id"?: number; "subscription_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/entitlements/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/episodes
   */
  getV1Episodes(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "title": string; "slug": string; "summary"?: string; "audio_url": string; "duration_seconds"?: number; "published_at"?: unknown; "status": "draft" | "scheduled" | "published" | "archived"; "team_id"?: number; "podcast_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/episodes", {}, [], false, options)
  },

  /**
   * POST /api/v1/episodes
   */
  postV1Episodes(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "summary"?: string; "audio_url": string; "duration_seconds"?: number; "published_at"?: unknown; "status": "draft" | "scheduled" | "published" | "archived"; "team_id"?: number; "podcast_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/episodes", {}, [], false, options)
  },

  /**
   * POST /api/v1/episodes/bulk-delete
   */
  postV1EpisodesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/episodes/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/episodes/{id}
   */
  getV1EpisodesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "summary"?: string; "audio_url": string; "duration_seconds"?: number; "published_at"?: unknown; "status": "draft" | "scheduled" | "published" | "archived"; "team_id"?: number; "podcast_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/episodes/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/episodes/{id}
   */
  putV1EpisodesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "summary"?: string; "audio_url": string; "duration_seconds"?: number; "published_at"?: unknown; "status": "draft" | "scheduled" | "published" | "archived"; "team_id"?: number; "podcast_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/episodes/{id}", input ?? {}, [], false, options)
  },
   ...
   */
  deleteV1EpisodesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "summary"?: string; "audio_url": string; "duration_seconds"?: number; "published_at"?: unknown; "status": "draft" | "scheduled" | "published" | "archived"; "team_id"?: number; "podcast_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/episodes/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/episodes/{id}
   */
  patchV1EpisodesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "summary"?: string; "audio_url": string; "duration_seconds"?: number; "published_at"?: unknown; "status": "draft" | "scheduled" | "published" | "archived"; "team_id"?: number; "podcast_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/episodes/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/form-submissions
   */
  getV1FormSubmissions(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "payload": unknown; "dedupe_key": string; "source_url"?: string; "status": "accepted" | "confirmed" | "rejected" | "spam"; "team_id"?: number; "form_definition_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/form-submissions", {}, [], false, options)
  },

  /**
   * GET /api/v1/form-submissions/{id}
   */
  getV1FormSubmissionsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "payload": unknown; "dedupe_key": string; "source_url"?: string; "status": "accepted" | "confirmed" | "rejected" | "spam"; "team_id"?: number; "form_definition_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/form-submissions/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/forms
   */
  getV1Forms(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "slug": string; "kind": "inline" | "popup" | "landing_page" | "gated_resource"; "schema_document": unknown; "double_opt_in": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "site_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/forms", {}, [], false, options)
  },

  /**
   * POST /api/v1/forms
   */
  postV1Forms(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "kind": "inline" | "popup" | "landing_page" | "gated_resource"; "schema_document": unknown; "double_opt_in": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "site_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/forms", {}, [], false, options)
  },

  /**
   * POST /api/v1/forms/bulk-delete
   */
  postV1FormsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/forms/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/forms/{id}
   */
  getV1FormsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "kind": "inline" | "popup" | "landing_page" | "gated_resource"; "schema_document": unknown; "double_opt_in": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "site_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/forms/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/forms/{id}
   */
  putV1FormsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "kind": "inline" | "popup" | "landing_page" | "gated_resource"; "schema_document": unknown; "double_opt_in": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "site_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/forms/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/forms/{id}
   */
  deleteV1FormsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "kind": "inline" | "popup" | "landing_page" | "gated_resource"; "schema_document": unknown; "double_opt_in": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "site_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/forms/{id}", input ?? {}, [], false, options)
  },
   ...
   */
  patchV1FormsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "kind": "inline" | "popup" | "landing_page" | "gated_resource"; "schema_document": unknown; "double_opt_in": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "site_id"?: number; "audience_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/forms/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/gated-resources
   */
  getV1GatedResources(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "slug": string; "access": "subscriber" | "paid" | "product" | "segment"; "segment_id"?: number; "content": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "publication_id"?: number; "product_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/gated-resources", {}, [], false, options)
  },

  /**
   * POST /api/v1/gated-resources
   */
  postV1GatedResources(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "access": "subscriber" | "paid" | "product" | "segment"; "segment_id"?: number; "content": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "publication_id"?: number; "product_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/gated-resources", {}, [], false, options)
  },

  /**
   * POST /api/v1/gated-resources/bulk-delete
   */
  postV1GatedResourcesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/gated-resources/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/gated-resources/{id}
   */
  getV1GatedResourcesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "access": "subscriber" | "paid" | "product" | "segment"; "segment_id"?: number; "content": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "publication_id"?: number; "product_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/gated-resources/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/gated-resources/{id}
   */
  putV1GatedResourcesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "access": "subscriber" | "paid" | "product" | "segment"; "segment_id"?: number; "content": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "publication_id"?: number; "product_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/gated-resources/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/gated-resources/{id}
   */
  deleteV1GatedResourcesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "access": "subscriber" | "paid" | "product" | "segment"; "segment_id"?: number; "content": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "publication_id"?: number; "product_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/gated-resources/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/gated-resources/{id}
   */
  patchV1GatedResourcesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "access": "subscriber" | "paid" | "product" | "segment"; "segment_id"?: number; "content": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "publication_id"?: number; "product_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/gated-resources/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/integration-credentials
   */
  getV1IntegrationCredentials(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "bedrock" | "generic"; "name": string; "last_four"?: string; "rotated_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/integration-credentials", {}, [], false, options)
  },

  /**
   * POST /api/v1/integration-credentials/bulk-delete
   */
  postV1IntegrationCredentialsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/integration-credentials/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/integration-credentials/{id}
   */
  getV1IntegrationCredentialsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "bedrock" | "generic"; "name": string; "last_four"?: string; "rotated_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/integration-credentials/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/integration-credentials/{id}
   */
  deleteV1IntegrationCredentialsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "bedrock" | "generic"; "name": string; "last_four"?: string; "rotated_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/integration-credentials/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/landing-pages
   */
  getV1LandingPages(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "slug": string; "status": "draft" | "scheduled" | "published" | "archived"; "document": unknown; "seo": unknown; "published_at"?: unknown; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/landing-pages", {}, [], false, options)
  },

  /**
   * POST /api/v1/landing-pages
   */
  postV1LandingPages(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "status": "draft" | "scheduled" | "published" | "archived"; "document": unknown; "seo": unknown; "published_at"?: unknown; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/landing-pages", {}, [], false, options)
  },

  /**
   * POST /api/v1/landing-pages/bulk-delete
   */
  postV1LandingPagesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/landing-pages/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/landing-pages/{id}
   */
  getV1LandingPagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "status": "draft" | "scheduled" | "published" | "archived"; "document": unknown; "seo": unknown; "published_at"?: unknown; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/landing-pages/{id}", input ?? {}, [], false, options)
  },
   ...
   */
  putV1LandingPagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "status": "draft" | "scheduled" | "published" | "archived"; "document": unknown; "seo": unknown; "published_at"?: unknown; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/landing-pages/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/landing-pages/{id}
   */
  deleteV1LandingPagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "status": "draft" | "scheduled" | "published" | "archived"; "document": unknown; "seo": unknown; "published_at"?: unknown; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/landing-pages/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/landing-pages/{id}
   */
  patchV1LandingPagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "status": "draft" | "scheduled" | "published" | "archived"; "document": unknown; "seo": unknown; "published_at"?: unknown; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/landing-pages/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/link-pages
   */
  getV1LinkPages(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "title": string; "slug": string; "bio"?: string; "links": unknown; "theme": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/link-pages", {}, [], false, options)
  },

  /**
   * POST /api/v1/link-pages
   */
  postV1LinkPages(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "bio"?: string; "links": unknown; "theme": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/link-pages", {}, [], false, options)
  },

  /**
   * POST /api/v1/link-pages/bulk-delete
   */
  postV1LinkPagesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/link-pages/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/link-pages/{id}
   */
  getV1LinkPagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "bio"?: string; "links": unknown; "theme": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/link-pages/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/link-pages/{id}
   */
  putV1LinkPagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "bio"?: string; "links": unknown; "theme": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/link-pages/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/link-pages/{id}
   */
  deleteV1LinkPagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "bio"?: string; "links": unknown; "theme": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/link-pages/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/link-pages/{id}
   */
  patchV1LinkPagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "bio"?: string; "links": unknown; "theme": unknown; "status": "draft" | "published" | "archived"; "team_id"?: number; "site_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/link-pages/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/message-blocks
   */
  getV1MessageBlocks(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "type": "heading" | "text" | "image" | "button" | "divider" | "product" | "columns" | "footer"; "content": unknown; "styles"?: unknown; "position": number; "reusable": boolean; "team_id"?: number; "message_template_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/message-blocks", {}, [], false, options)
  },

  /**
   * POST /api/v1/message-blocks
   */
  postV1MessageBlocks(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "heading" | "text" | "image" | "button" | "divider" | "product" | "columns" | "footer"; "content": unknown; "styles"?: unknown; "position": number; "reusable": boolean; "team_id"?: number; "message_template_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/message-blocks", {}, [], false, options)
  },

  /**
   * POST /api/v1/message-blocks/bulk-delete
   */
  postV1MessageBlocksBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/message-blocks/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/message-blocks/{id}
   */
  getV1MessageBlocksId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "heading" | "text" | "image" | "button" | "divider" | "product" | "columns" | "footer"; "content": unknown; "styles"?: unknown; "position": number; "reusable": boolean; "team_id"?: number; "message_template_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/message-blocks/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/message-blocks/{id}
   */
  putV1MessageBlocksId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "heading" | "text" | "image" | "button" | "divider" | "product" | "columns" | "footer"; "content": unknown; "styles"?: unknown; "position": number; "reusable": boolean; "team_id"?: number; "message_template_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/message-blocks/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/message-blocks/{id}
   */
  deleteV1MessageBlocksId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "heading" | "text" | "image" | "button" | "divider" | "product" | "columns" | "footer"; "content": unknown; "styles"?: unknown; "position": number; "reusable": boolean; "team_id"?: number; "message_template_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/message-blocks/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/message-blocks/{id}
   */
  patchV1MessageBlocksId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "type": "heading" | "text" | "image" | "button" | "divider" | "product" | "columns" | "footer"; "content": unknown; "styles"?: unknown; "position": number; "reusable": boolean; "team_id"?: number; "message_template_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/message-blocks/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/message-templates
   */
  getV1MessageTemplates(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "channel": "email" | "sms" | "landing_page"; "subject"?: string; "document": unknown; "plain_text"?: string; "revision": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/message-templates", {}, [], false, options)
  },

  /**
   * POST /api/v1/message-templates
   */
  postV1MessageTemplates(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "channel": "email" | "sms" | "landing_page"; "subject"?: string; "document": unknown; "plain_text"?: string; "revision": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/message-templates", {}, [], false, options)
  },

  /**
   * POST /api/v1/message-templates/bulk-delete
   */
  postV1MessageTemplatesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/message-templates/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/message-templates/{id}
   */
  getV1MessageTemplatesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "channel": "email" | "sms" | "landing_page"; "subject"?: string; "document": unknown; "plain_text"?: string; "revision": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/message-templates/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/message-templates/{id}
   */
  putV1MessageTemplatesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "channel": "email" | "sms" | "landing_page"; "subject"?: string; "document": unknown; "plain_text"?: string; "revision": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/message-templates/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/message-templates/{id}
   */
  deleteV1MessageTemplatesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "channel": "email" | "sms" | "landing_page"; "subject"?: string; "document": unknown; "plain_text"?: string; "revision": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/message-templates/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/message-templates/{id}
   */
  patchV1MessageTemplatesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "channel": "email" | "sms" | "landing_page"; "subject"?: string; "document": unknown; "plain_text"?: string; "revision": number; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/message-templates/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/payouts
   */
  getV1Payouts(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "provider_id"?: string; "amount": number; "currency": string; "status": "pending" | "processing" | "paid" | "failed" | "cancelled"; "scheduled_at"?: unknown; "paid_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/payouts", {}, [], false, options)
  },

  /**
   * GET /api/v1/payouts/{id}
   */
  getV1PayoutsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider_id"?: string; "amount": number; "currency": string; "status": "pending" | "processing" | "paid" | "failed" | "cancelled"; "scheduled_at"?: unknown; "paid_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/payouts/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/podcasts
   */
  getV1Podcasts(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "title": string; "slug": string; "description"?: string; "author": string; "explicit": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/podcasts", {}, [], false, options)
  },

  /**
   * POST /api/v1/podcasts
   */
  postV1Podcasts(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "description"?: string; "author": string; "explicit": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/podcasts", {}, [], false, options)
  },

  /**
   * POST /api/v1/podcasts/bulk-delete
   */
  postV1PodcastsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/podcasts/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/podcasts/{id}
   */
  getV1PodcastsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "description"?: string; "author": string; "explicit": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/podcasts/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/podcasts/{id}
   */
  putV1PodcastsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "description"?: string; "author": string; "explicit": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/podcasts/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/podcasts/{id}
   */
  deleteV1PodcastsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "description"?: string; "author": string; "explicit": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/podcasts/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/podcasts/{id}
   */
  patchV1PodcastsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "title": string; "slug": string; "description"?: string; "author": string; "explicit": boolean; "status": "draft" | "active" | "archived"; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/podcasts/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/publication-members
   */
  getV1PublicationMembers(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "status": "pending" | "active" | "cancelled" | "past_due"; "tier": string; "started_at"?: unknown; "ended_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/publication-members", {}, [], false, options)
  },

  /**
   * POST /api/v1/publication-members
   */
  postV1PublicationMembers(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "pending" | "active" | "cancelled" | "past_due"; "tier": string; "started_at"?: unknown; "ended_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/publication-members", {}, [], false, options)
  },

  /**
   * POST /api/v1/publication-members/bulk-delete
   */
  postV1PublicationMembersBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/publication-members/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/publication-members/{id}
   */
  getV1PublicationMembersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "pending" | "active" | "cancelled" | "past_due"; "tier": string; "started_at"?: unknown; "ended_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/publication-members/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/publication-members/{id}
   */
  putV1PublicationMembersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "pending" | "active" | "cancelled" | "past_due"; "tier": string; "started_at"?: unknown; "ended_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/publication-members/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/publication-members/{id}
   */
  deleteV1PublicationMembersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "pending" | "active" | "cancelled" | "past_due"; "tier": string; "started_at"?: unknown; "ended_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/publication-members/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/publication-members/{id}
   */
  patchV1PublicationMembersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "status": "pending" | "active" | "cancelled" | "past_due"; "tier": string; "started_at"?: unknown; "ended_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/publication-members/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/publications
   */
  getV1Publications(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "slug": string; "description"?: string; "status": "draft" | "active" | "paused" | "archived"; "access": "free" | "paid" | "mixed"; "settings"?: unknown; "team_id"?: number; "site_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/publications", {}, [], false, options)
  },

  /**
   * POST /api/v1/publications
   */
  postV1Publications(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "description"?: string; "status": "draft" | "active" | "paused" | "archived"; "access": "free" | "paid" | "mixed"; "settings"?: unknown; "team_id"?: number; "site_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/publications", {}, [], false, options)
  },

  /**
   * POST /api/v1/publications/bulk-delete
   */
  postV1PublicationsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/publications/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/publications/{id}
   */
  getV1PublicationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "description"?: string; "status": "draft" | "active" | "paused" | "archived"; "access": "free" | "paid" | "mixed"; "settings"?: unknown; "team_id"?: number; "site_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/publications/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/publications/{id}
   */
  putV1PublicationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "description"?: string; "status": "draft" | "active" | "paused" | "archived"; "access": "free" | "paid" | "mixed"; "settings"?: unknown; "team_id"?: number; "site_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/publications/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/publications/{id}
   */
  deleteV1PublicationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "description"?: string; "status": "draft" | "active" | "paused" | "archived"; "access": "free" | "paid" | "mixed"; "settings"?: unknown; "team_id"?: number; "site_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/publications/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/publications/{id}
   */
  patchV1PublicationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "slug": string; "description"?: string; "status": "draft" | "active" | "paused" | "archived"; "access": "free" | "paid" | "mixed"; "settings"?: unknown; "team_id"?: number; "site_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/publications/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/recommendations
   */
  getV1Recommendations(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "partner_publication_id": number; "direction": "outbound" | "inbound" | "exchange"; "status": "pending" | "active" | "paused" | "declined" | "ended"; "reward_amount": number; "currency": string; "terms": unknown; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/recommendations", {}, [], false, options)
  },

  /**
   * POST /api/v1/recommendations
   */
  postV1Recommendations(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "partner_publication_id": number; "direction": "outbound" | "inbound" | "exchange"; "status": "pending" | "active" | "paused" | "declined" | "ended"; "reward_amount": number; "currency": string; "terms": unknown; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/recommendations", {}, [], false, options)
  },

  /**
   * POST /api/v1/recommendations/bulk-delete
   */
  postV1RecommendationsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/recommendations/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/recommendations/{id}
   */
  getV1RecommendationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "partner_publication_id": number; "direction": "outbound" | "inbound" | "exchange"; "status": "pending" | "active" | "paused" | "declined" | "ended"; "reward_amount": number; "currency": string; "terms": unknown; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/recommendations/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/recommendations/{id}
   */
  putV1RecommendationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "partner_publication_id": number; "direction": "outbound" | "inbound" | "exchange"; "status": "pending" | "active" | "paused" | "declined" | "ended"; "reward_amount": number; "currency": string; "terms": unknown; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/recommendations/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/recommendations/{id}
   */
  deleteV1RecommendationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "partner_publication_id": number; "direction": "outbound" | "inbound" | "exchange"; "status": "pending" | "active" | "paused" | "declined" | "ended"; "reward_amount": number; "currency": string; "terms": unknown; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/recommendations/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/recommendations/{id}
   */
  patchV1RecommendationsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "partner_publication_id": number; "direction": "outbound" | "inbound" | "exchange"; "status": "pending" | "active" | "paused" | "declined" | "ended"; "reward_amount": number; "currency": string; "terms": unknown; "team_id"?: number; "publication_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/recommendations/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/referrals
   */
  getV1Referrals(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "code": string; "status": "clicked" | "pending" | "qualified" | "rewarded" | "rejected"; "reward"?: unknown; "qualified_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/referrals", {}, [], false, options)
  },

  /**
   * GET /api/v1/referrals/{id}
   */
  getV1ReferralsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "code": string; "status": "clicked" | "pending" | "qualified" | "rewarded" | "rejected"; "reward"?: unknown; "qualified_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/referrals/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/referrals/{id}
   */
  putV1ReferralsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "code": string; "status": "clicked" | "pending" | "qualified" | "rewarded" | "rejected"; "reward"?: unknown; "qualified_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/referrals/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/referrals/{id}
   */
  patchV1ReferralsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "code": string; "status": "clicked" | "pending" | "qualified" | "rewarded" | "rejected"; "reward"?: unknown; "qualified_at"?: unknown; "team_id"?: number; "publication_id"?: number; "contact_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/referrals/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/segment-rules
   */
  getV1SegmentRules(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "field": string; "operator": "equals" | "not_equals" | "contains" | "greater_than" | "less_than" | "before" | "after" | "exists" | "not_exists" | "in"; "value"?: unknown; "position": number; "team_id"?: number; "segment_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/segment-rules", {}, [], false, options)
  },

  /**
   * POST /api/v1/segment-rules
   */
  postV1SegmentRules(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "field": string; "operator": "equals" | "not_equals" | "contains" | "greater_than" | "less_than" | "before" | "after" | "exists" | "not_exists" | "in"; "value"?: unknown; "position": number; "team_id"?: number; "segment_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/segment-rules", {}, [], false, options)
  },

  /**
   * POST /api/v1/segment-rules/bulk-delete
   */
  postV1SegmentRulesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/segment-rules/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/segment-rules/{id}
   */
  getV1SegmentRulesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "field": string; "operator": "equals" | "not_equals" | "contains" | "greater_than" | "less_than" | "before" | "after" | "exists" | "not_exists" | "in"; "value"?: unknown; "position": number; "team_id"?: number; "segment_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/segment-rules/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/segment-rules/{id}
   */
  putV1SegmentRulesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "field": string; "operator": "equals" | "not_equals" | "contains" | "greater_than" | "less_than" | "before" | "after" | "exists" | "not_exists" | "in"; "value"?: unknown; "position": number; "team_id"?: number; "segment_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/segment-rules/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/segment-rules/{id}
   */
  deleteV1SegmentRulesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "field": string; "operator": "equals" | "not_equals" | "contains" | "greater_than" | "less_than" | "before" | "after" | "exists" | "not_exists" | "in"; "value"?: unknown; "position": number; "team_id"?: number; "segment_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/segment-rules/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/segment-rules/{id}
   */
  patchV1SegmentRulesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "field": string; "operator": "equals" | "not_equals" | "contains" | "greater_than" | "less_than" | "before" | "after" | "exists" | "not_exists" | "in"; "value"?: unknown; "position": number; "team_id"?: number; "segment_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/segment-rules/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/segment-snapshots
   */
  getV1SegmentSnapshots(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "rule_checksum": string; "contact_ids": unknown; "contact_count": number; "source": "campaign" | "automation" | "export" | "preview"; "created_by": number; "team_id"?: number; "segment_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/segment-snapshots", {}, [], false, options)
  },

  /**
   * GET /api/v1/segment-snapshots/{id}
   */
  getV1SegmentSnapshotsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "rule_checksum": string; "contact_ids": unknown; "contact_count": number; "source": "campaign" | "automation" | "export" | "preview"; "created_by": number; "team_id"?: number; "segment_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/segment-snapshots/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/segments
   */
  getV1Segments(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "description"?: string; "match_type": "all" | "any"; "estimated_count": number; "refreshed_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/segments", {}, [], false, options)
  },

  /**
   * POST /api/v1/segments
   */
  postV1Segments(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "match_type": "all" | "any"; "estimated_count": number; "refreshed_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/segments", {}, [], false, options)
  },

  /**
   * POST /api/v1/segments/bulk-delete
   */
  postV1SegmentsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/segments/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/segments/{id}
   */
  getV1SegmentsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "match_type": "all" | "any"; "estimated_count": number; "refreshed_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/segments/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/segments/{id}
   */
  putV1SegmentsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "match_type": "all" | "any"; "estimated_count": number; "refreshed_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/segments/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/segments/{id}
   */
  deleteV1SegmentsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "match_type": "all" | "any"; "estimated_count": number; "refreshed_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/segments/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/segments/{id}
   */
  patchV1SegmentsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "description"?: string; "match_type": "all" | "any"; "estimated_count": number; "refreshed_at"?: unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/segments/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/sender-identities
   */
  getV1SenderIdentities(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "channel": "email" | "sms"; "name": string; "address": string; "reply_to"?: string; "status": "pending" | "verified" | "disabled" | "failed"; "verification"?: unknown; "team_id"?: number; "sender_domain_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/sender-identities", {}, [], false, options)
  },

  /**
   * POST /api/v1/sender-identities
   */
  postV1SenderIdentities(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms"; "name": string; "address": string; "reply_to"?: string; "status": "pending" | "verified" | "disabled" | "failed"; "verification"?: unknown; "team_id"?: number; "sender_domain_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/sender-identities", {}, [], false, options)
  },

  /**
   * POST /api/v1/sender-identities/bulk-delete
   */
  postV1SenderIdentitiesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/sender-identities/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/sender-identities/{id}
   */
  getV1SenderIdentitiesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms"; "name": string; "address": string; "reply_to"?: string; "status": "pending" | "verified" | "disabled" | "failed"; "verification"?: unknown; "team_id"?: number; "sender_domain_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/sender-identities/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/sender-identities/{id}
   */
  putV1SenderIdentitiesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms"; "name": string; "address": string; "reply_to"?: string; "status": "pending" | "verified" | "disabled" | "failed"; "verification"?: unknown; "team_id"?: number; "sender_domain_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/sender-identities/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/sender-identities/{id}
   */
  deleteV1SenderIdentitiesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms"; "name": string; "address": string; "reply_to"?: string; "status": "pending" | "verified" | "disabled" | "failed"; "verification"?: unknown; "team_id"?: number; "sender_domain_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/sender-identities/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/sender-identities/{id}
   */
  patchV1SenderIdentitiesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "channel": "email" | "sms"; "name": string; "address": string; "reply_to"?: string; "status": "pending" | "verified" | "disabled" | "failed"; "verification"?: unknown; "team_id"?: number; "sender_domain_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/sender-identities/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/sms-messages
   */
  getV1SmsMessages(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "body": string; "encoding": "gsm7" | "ucs2"; "segment_count": number; "stop_language_included": boolean; "quiet_hours_timezone": string; "revision": number; "team_id"?: number; "campaign_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/sms-messages", {}, [], false, options)
  },

  /**
   * POST /api/v1/sms-messages
   */
  postV1SmsMessages(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "body": string; "encoding": "gsm7" | "ucs2"; "segment_count": number; "stop_language_included": boolean; "quiet_hours_timezone": string; "revision": number; "team_id"?: number; "campaign_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/sms-messages", {}, [], false, options)
  },

  /**
   * POST /api/v1/sms-messages/bulk-delete
   */
  postV1SmsMessagesBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/sms-messages/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/sms-messages/{id}
   */
  getV1SmsMessagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "body": string; "encoding": "gsm7" | "ucs2"; "segment_count": number; "stop_language_included": boolean; "quiet_hours_timezone": string; "revision": number; "team_id"?: number; "campaign_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/sms-messages/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/sms-messages/{id}
   */
  putV1SmsMessagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "body": string; "encoding": "gsm7" | "ucs2"; "segment_count": number; "stop_language_included": boolean; "quiet_hours_timezone": string; "revision": number; "team_id"?: number; "campaign_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/sms-messages/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/sms-messages/{id}
   */
  deleteV1SmsMessagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "body": string; "encoding": "gsm7" | "ucs2"; "segment_count": number; "stop_language_included": boolean; "quiet_hours_timezone": string; "revision": number; "team_id"?: number; "campaign_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/sms-messages/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/sms-messages/{id}
   */
  patchV1SmsMessagesId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "body": string; "encoding": "gsm7" | "ucs2"; "segment_count": number; "stop_language_included": boolean; "quiet_hours_timezone": string; "revision": number; "team_id"?: number; "campaign_id"?: number; "sender_identity_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/sms-messages/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/sponsors
   */
  getV1Sponsors(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "contact_email": string; "website"?: string; "status": "prospect" | "active" | "paused" | "blocked"; "notes"?: string; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/sponsors", {}, [], false, options)
  },

  /**
   * POST /api/v1/sponsors
   */
  postV1Sponsors(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "contact_email": string; "website"?: string; "status": "prospect" | "active" | "paused" | "blocked"; "notes"?: string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/sponsors", {}, [], false, options)
  },

  /**
   * POST /api/v1/sponsors/bulk-delete
   */
  postV1SponsorsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/sponsors/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/sponsors/{id}
   */
  getV1SponsorsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "contact_email": string; "website"?: string; "status": "prospect" | "active" | "paused" | "blocked"; "notes"?: string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/sponsors/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/sponsors/{id}
   */
  putV1SponsorsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "contact_email": string; "website"?: string; "status": "prospect" | "active" | "paused" | "blocked"; "notes"?: string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/sponsors/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/sponsors/{id}
   */
  deleteV1SponsorsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "contact_email": string; "website"?: string; "status": "prospect" | "active" | "paused" | "blocked"; "notes"?: string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/sponsors/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/sponsors/{id}
   */
  patchV1SponsorsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "contact_email": string; "website"?: string; "status": "prospect" | "active" | "paused" | "blocked"; "notes"?: string; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/sponsors/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/usage-meters
   */
  getV1UsageMeters(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "key": "contacts" | "emails" | "sms_segments" | "ai_generations" | "custom_domains"; "quantity": number; "included_quantity": number; "period_start": unknown; "period_end": unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/usage-meters", {}, [], false, options)
  },

  /**
   * GET /api/v1/usage-meters/{id}
   */
  getV1UsageMetersId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "key": "contacts" | "emails" | "sms_segments" | "ai_generations" | "custom_domains"; "quantity": number; "included_quantity": number; "period_start": unknown; "period_end": unknown; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/usage-meters/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/webhook-endpoints
   */
  getV1WebhookEndpoints(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "name": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "generic"; "direction": "inbound" | "outbound"; "url"?: string; "events": unknown; "status": "active" | "paused" | "failing"; "team_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/webhook-endpoints", {}, [], false, options)
  },

  /**
   * POST /api/v1/webhook-endpoints
   */
  postV1WebhookEndpoints(options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "generic"; "direction": "inbound" | "outbound"; "url"?: string; "events": unknown; "status": "active" | "paused" | "failing"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "POST", "/api/v1/webhook-endpoints", {}, [], false, options)
  },

  /**
   * POST /api/v1/webhook-endpoints/bulk-delete
   */
  postV1WebhookEndpointsBulkDelete(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/v1/webhook-endpoints/bulk-delete", {}, [], false, options)
  },

  /**
   * GET /api/v1/webhook-endpoints/{id}
   */
  getV1WebhookEndpointsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "generic"; "direction": "inbound" | "outbound"; "url"?: string; "events": unknown; "status": "active" | "paused" | "failing"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/webhook-endpoints/{id}", input ?? {}, [], false, options)
  },

  /**
   * PUT /api/v1/webhook-endpoints/{id}
   */
  putV1WebhookEndpointsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "generic"; "direction": "inbound" | "outbound"; "url"?: string; "events": unknown; "status": "active" | "paused" | "failing"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PUT", "/api/v1/webhook-endpoints/{id}", input ?? {}, [], false, options)
  },

  /**
   * DELETE /api/v1/webhook-endpoints/{id}
   */
  deleteV1WebhookEndpointsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "generic"; "direction": "inbound" | "outbound"; "url"?: string; "events": unknown; "status": "active" | "paused" | "failing"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "DELETE", "/api/v1/webhook-endpoints/{id}", input ?? {}, [], false, options)
  },

  /**
   * PATCH /api/v1/webhook-endpoints/{id}
   */
  patchV1WebhookEndpointsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "name": string; "provider": "twilio" | "stripe" | "shopify" | "woocommerce" | "mail" | "generic"; "direction": "inbound" | "outbound"; "url"?: string; "events": unknown; "status": "active" | "paused" | "failing"; "team_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "PATCH", "/api/v1/webhook-endpoints/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/webhook-events
   */
  getV1WebhookEvents(options?: RequestOptions): Promise<ApiResult<{ "data": Array<{ "id": number; "uuid": string; "provider": string; "provider_event_id": string; "type": string; "status": "received" | "processing" | "processed" | "failed" | "dead_lettered"; "signature_verified": boolean; "attempts": number; "error"?: string; "processed_at"?: unknown; "team_id"?: number; "webhook_endpoint_id"?: number; "created_at"?: string; "updated_at"?: string }> }>> {
    return request(config, "GET", "/api/v1/webhook-events", {}, [], false, options)
  },

  /**
   * GET /api/v1/webhook-events/{id}
   */
  getV1WebhookEventsId(input: { "id": string }, options?: RequestOptions): Promise<ApiResult<{ "data": { "id": number; "uuid": string; "provider": string; "provider_event_id": string; "type": string; "status": "received" | "processing" | "processed" | "failed" | "dead_lettered"; "signature_verified": boolean; "attempts": number; "error"?: string; "processed_at"?: unknown; "team_id"?: number; "webhook_endpoint_id"?: number; "created_at"?: string; "updated_at"?: string } }>> {
    return request(config, "GET", "/api/v1/webhook-events/{id}", input ?? {}, [], false, options)
  },

  /**
   * GET /api/v1/workspace
   */
  getV1Workspace(options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "GET", "/api/v1/workspace", {}, [], false, options)
  },
  ...
  /**
   * POST /api/webhooks/{provider}/{endpoint}
   */
  postWebhooksProviderEndpoint(input: { "provider": string; "endpoint": string }, options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/api/webhooks/{provider}/{endpoint}", input ?? {}, [], false, options)
  },
   ...
   * GET /confirm/{token}
   */
  getConfirmToken(input: { "token": string }, options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "GET", "/confirm/{token}", input ?? {}, [], false, options)
  },
   ...
   */
  postFormsFormSubmit(input: { "form": string }, options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/forms/{form}/submit", input ?? {}, [], false, options)
  },
   ...
   */
  getPreferencesToken(input: { "token": string }, options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "GET", "/preferences/{token}", input ?? {}, [], false, options)
  },

  /**
   * POST /preferences/{token}
   */
  postPreferencesToken(input: { "token": string }, options?: RequestOptions): Promise<ApiResult<Record<string, unknown>>> {
    return request(config, "POST", "/preferences/{token}", input ?? {}, [], false, options)
  },
